...
class DocumentServiceTest {
    ...
    void getAllDocuments() {
        ...
        assertAll(
                () -> assertNotNull(result, "Result should not be null"),
                () -> assertEquals(3, result.getContent().size(), "Should contain all documents")
        );
    ...
    void createDocument() {
        CreateDocumentRequest request = new CreateDocumentRequest(1L, 1L, "title1",
                (short) 1, "thumbnail1", "content1", "description1", LocalDateTime.now(), LocalDateTime.now());
        ...
        assertAll(
                () -> assertNotNull(result, "Created document should not be null"),
                () -> assertEquals("title1", result.getTitle(), "Title should match")
        );
